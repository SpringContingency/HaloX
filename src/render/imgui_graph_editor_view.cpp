#include "imgui_graph_editor_view.h"
...
c_imgui_graph_editor_view::c_imgui_graph_editor_view() {
	memset(this, 0, sizeof(c_imgui_graph_editor_view));
...
bool c_imgui_graph_editor_view::begin(bool* open) {
	prepare();
...
void c_imgui_graph_editor_view::end() {

}

c_imgui_graph_editor_view::s_position c_imgui_graph_editor_view::calculate_position(const ImVec2& coordinate_position, ImVec2& screen_position) {
	s_position position;
...
void c_imgui_graph_editor_view::prepare() {
...
void c_imgui_graph_editor_view::draw_background() {
...
void c_imgui_graph_editor_view::draw_grid() {
...
void c_imgui_graph_editor_view::draw_cursor() {
...
void c_imgui_graph_editor_view::handle_input() {
